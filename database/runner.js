...
const migrations = [
  { name: '001_create_products_table', file: './migrations/001_create_products_table.js' },
  { name: '002_create_sales_table', file: './migrations/002_create_sales_table.js' },
  { name: '003_create_roles_table', file: './migrations/003_create_roles_table.js' },
  { name: '004_create_users_table', file: './migrations/004_create_users_table.js' },
  { name: '005_create_user_roles_table', file: './migrations/005_create_user_roles_table.js' },
  { name: '006_create_ruangan_table', file: './migrations/006_create_ruangan_table.js' },
  { name: '007_create_bhp_table', file: './migrations/007_create_bhp_table.js' },
  { name: '008_create_draft_pengadaan_table', file: './migrations/008_create_draft_pengadaan_table.js' },
  { name: '009_create_detail_draft_table', file: './migrations/009_create_detail_draft_table.js' },
  { name: '010_create_inventaris_table', file: './migrations/010_create_inventaris_table.js' },
  { name: '011_create_maintenance_log_table', file: './migrations/011_create_maintenance_log_table.js' }
];
...
const seeders = [
  ...
  { name: '008_draft_pengadaan_seeder', file: './seeders/008_draft_pengadaan_seeder.js' },
  { name: '009_detail_draft_seeder', file: './seeders/009_detail_draft_seeder.js' },
  { name: '010_inventaris_seeder', file: './seeders/010_inventaris_seeder.js' },
  { name: '011_maintenance_log_seeder', file: './seeders/011_maintenance_log_seeder.js' }
];
